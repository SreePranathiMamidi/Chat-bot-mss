...
def get_gemini_response(user_prompt: str, model_name, temperature, top_p):
    ...
    try:
        ...
        You are an ai that only should answer about computers and its architecture only,
          if the prompt is unrelated to computers and its architecture reply back as i cant help you.
...
def main():
    ...
    dark_blue_html = """
        ...
        background-color: #00aae7; margin-top: -4px; border-radius: 3px;"></div>
        """
